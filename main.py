...
st.markdown("Upload your resume adn get AI-powered feedback tailored to your needs")

#st.text("hello")
# to run my application i will need to use: streamlit run main.py
...
if analyze and uploaded_file:
    ...
    try:
        ...
        Please provide your analysis in a clear, structured format with specific 
        recommendations
        """
